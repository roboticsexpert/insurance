...
- `offerPreview` **همیشه** برچسب «نرخ نمونه» دارد؛ نرخ زنده‌ای در کار نیست. ردیف‌های صفحه
  شخص ثالث نام سه شرکت را دارند ولی مبلغ‌هایشان جای‌نگارند، پس هیچ عددی به هیچ شرکتی
  نسبت داده نمی‌شود — جزئیات و هشدارش در `LANDING-PAGES.md`.
