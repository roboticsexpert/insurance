...
/**
 * ref‌ها مستقیم برگردانده می‌شوند، نه زیر `card.ref`/`link.ref`. قاعده
 * `react-hooks/refs` هر خواندن `.ref` هنگام رندر را خطا می‌گیرد و شکل تودرتوی قالب
 * اصلی روی هر `ref={card.ref}` آن را روشن می‌کرد.
 */
